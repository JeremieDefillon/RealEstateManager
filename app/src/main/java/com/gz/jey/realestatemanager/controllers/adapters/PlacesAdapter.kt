package com.gz.jey.realestatemanager.controllers.adapters
...
(context: Context,
 ...
 private val mPlaceFilter: AutocompleteFilter) : ArrayAdapter<AutocompletePrediction>(context, android.R.layout.simple_expandable_list_item_2, android.R.id.text1), Filterable {
     ...
     * successfully.
     * This method MUST be called off the mainPhoto UI thread, as it will block until data is returned
    ...
    private fun getAutocomplete(constraint: CharSequence?): ArrayList<AutocompletePrediction>? {
        if (mGoogleApiClient.isConnected) {
            ...
            // This method should have been called off the mainPhoto UI thread. Block and wait for at most 60s
